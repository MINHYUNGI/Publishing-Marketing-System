...
try {
    ...
    $UiPatches = @(
        ...
        (Join-Path $ScriptDir "app\sns_content_display_patch.py"),
        (Join-Path $ScriptDir "app\sns_content_readability_patch.py"),
        (Join-Path $ScriptDir "app\sns_remove_share_patch.py"),
        (Join-Path $ScriptDir "app\sns_youtube_only_metrics_patch.py"),
